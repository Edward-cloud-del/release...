...
*/
    ...
    */
    fn create_react_overlay_once(&self, app: &tauri::AppHandle) -> Result<WebviewWindow, String> {
        ...
        let (screen_width, screen_height, offset_x, offset_y) = match ScreenCapture::get_total_screen_area() {
            Ok(total_area) => {
                ...
                println!("📍 Overlay position: ({}, {}) covering area to ({}, {})", 
            ...
            Err(e) => {
                println!("⚠️ Failed to get total screen area: {}, falling back to single screen", e);
        ...
        println!("📐 Coordinate system: overlay (0,0) = screen ({}, {})", offset_x, offset_y);
